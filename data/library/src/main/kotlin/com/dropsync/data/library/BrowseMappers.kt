...
internal fun AlbumRow.toDomain(): Album = Album(title = album, artist = artist, trackCount = trackCount)

internal fun ArtistRow.toDomain(): Artist = Artist(name = artist, trackCount = trackCount, albumCount = albumCount)

internal fun GenreRow.toDomain(): Genre = Genre(name = genre, trackCount = trackCount)
